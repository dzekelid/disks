...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/disks/master/_listings/aws-storage-gateway-service/apis.md
...
- name: AWS Storage Gateway Service API - List Local Disks
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/disks/master/_listings/aws-storage-gateway-service/actionlistlocaldisks-get-openapi.md
- name: AWS Storage Gateway Service API - List Local Disks
  x-api-slug: actionlistlocaldisks-get
  description: Returns a list of the gateway's local disks.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/Storage-Content-Delivery_AWSStorageGateway.png
